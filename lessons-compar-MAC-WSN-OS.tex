...
\RRetitle{Practical Lessons Learned through Implementation and Performance
          Evaluation of Two MAC/RDC Protocols on WSN OS}

\titlehead{Practical Lessons Learned through Implementation\ldots}
...
\RRtitle{Leçons pratiques apprises via l'implémentation et l'évaluation
         de performances de deux protocoles MAC~/ RDC sur des OS pour
...
{\small
\bibliography{lessons-compar-MAC-WSN-OS}}
